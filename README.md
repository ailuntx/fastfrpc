...
docker run -d \
  ...
  your-dockerhub-user/fastfrpc:latest
```
...
```bash
docker buildx build --platform linux/arm64,linux/amd64 -t your-dockerhub-user/fastfrpc:latest -f Dockerfile.fastfrpc --push .
```
